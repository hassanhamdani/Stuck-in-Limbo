...
namespace Gamekit3D
{
    ...
    public class ChomperBehavior : MonoBehaviour, IMessageReceiver
    {
        ...
        //exrta
                [Tooltip("Time in seconds before the Chomper dies")]
            ...
            else
            {
                ...
                if (target == null)
                {
                    ...
                    if (m_TimerSinceLostTarget >= timeToStopPursuit)
                    {
                        ...
                        if (toTarget.sqrMagnitude > playerScanner.detectionRadius*5f * playerScanner.detectionRadius*5f)
                        {
                            if (m_FollowerInstance != null)
                                m_FollowerInstance.distributor.UnregisterFollower(m_FollowerInstance);
        ...
        public void RequestTargetPosition()
        {
            ...
            m_FollowerInstance.requiredPoint = m_Target.transform.position + fromTarget.normalized * attackDistance * 100.9f;
        }
