...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        //Define mhashSprint
        // readonly int m_HashSprint = Animator.StringToHash("Sprint");
        ...
        void CalculateForwardMovement()
        {
            ...
            if(m_Input.DashInput){
                m_ForwardSpeed = Mathf.MoveTowards(m_ForwardSpeed, m_DesiredForwardSpeed*5f, acceleration*5f * Time.deltaTime);
            }
            else{
        ...
        void OnAnimatorMove()
        {
            ...
            // If shift key is pressed then the player will sprint 
            if (Input.GetKey(KeyCode.LeftShift))
            {
                m_Animator.SetBool(m_HashSprint, true);
                m_ForwardSpeed = Mathf.Lerp(m_ForwardSpeed, m_DesiredForwardSpeed, Time.deltaTime * 5f);
            }
            else
            {
                m_Animator.SetBool(m_HashSprint, false);
                m_ForwardSpeed = Mathf.Lerp(m_ForwardSpeed, m_DesiredForwardSpeed, Time.deltaTime * 5f);
            }
        ...
        //mhashsprint definitoon
        static int m_HashSprint = Animator.StringToHash("Sprint");
